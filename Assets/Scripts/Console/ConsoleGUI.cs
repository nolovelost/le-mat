...
public class ConsoleGUI : MonoBehaviour, IConsoleUI
{
    ...
    public void ConsoleUpdate()
    {
        ...
        // Debug purposes only
        if (Input.GetKeyDown(KeyCode.Return) && Input.GetKeyDown(KeyCode.RightControl))
        {
            OnSubmit(input_field.text);
        }
    }
    ...
    public void OnSubmit(string value)
    {
        ...
        GameDebug.Log("Console command submitted.");
